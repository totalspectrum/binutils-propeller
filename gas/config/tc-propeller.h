...
TC_PARSE_CONS_RETURN_TYPE propeller_cons (expressionS *, int);
void propeller_cons_fix_new (struct frag *, int, unsigned int, struct expressionS *, TC_PARSE_CONS_RETURN_TYPE reloc);
